...
const createInput = (id, placeholder, iconText, type) => {
...
const renderUi = () => {
    ...
    credentials.append(createInput("username", "login", "◌", "text"), createInput("password", "password", "◔", "password"));
...
const setStatus = (ui, message, type = "") => {
